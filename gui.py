...
class AppWindow:
    ...
    def __init__(self, width, height):
        ...
        self._loadedMeshVis.set_on_sun_direction_changed(self._on_sun_dir)
        self._loadedMeshVis.background_color = gui.Color(1, 0, 0)

        #self._controls_panel.add_child(self._loadedMeshVis)
    ...
    def _on_load_mesh_done(self, filename):
        self.window.close_dialog()
        self._loadedMesh = lm.load_mesh(filename, False)
    ...
    def _apply_settings(self):
        ...
        self._gridPanel.background_color = gui.Color(0, 0, 0)
